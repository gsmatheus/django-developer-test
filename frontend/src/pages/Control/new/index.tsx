...
export function NewControlPage() {
  ...
  return (
    <div className="h-full flex-1 flex-col space-y-8 p-8 md:flex">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Registrar novo controle de viagem</CardTitle>
          <CardDescription>
            Preencha os campos abaixo para registrar um novo controle de viagem.
          </CardDescription>
        </CardHeader>
        {!loading && (
          <CardContent>
              ...
              >
                ...
                <div className="flex justify-between pt-5">
                  ...
                  <Button type="submit" disabled={sendingData}>
                    {sendingData ? "Enviando..." : "Registrar"}
                  </Button>
                </div>
              </form>
            </Form>
